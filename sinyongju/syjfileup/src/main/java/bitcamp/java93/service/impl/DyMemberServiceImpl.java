...
public class DyMemberServiceImpl implements DyMemberService {
  ...
  @Override
  public void PhotPath(String path, int no) {
	HashMap<String,Object> userphotMap = new HashMap<>();
	userphotMap.put("path", path);
	userphotMap.put("no", no);
	dyMemberDao.updatePhot(userphotMap);
  }
